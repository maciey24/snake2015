...
//            }
        ...
        if(!(game->getPaused()))
        {
            //To działa w tym miejscu, tylko ten break...
            if( event.type == SDL_QUIT )
            {
                quit = true;
                break;
            ...
            for(int i=0;i<map->getHeight();i++)
            {
                ...
                {
                    //Obliczanie współrzędnych kolejnych kwadratów, będących elementami mapy
                    //Zależnie od elementu rysowany jest kwadrat w innym kolorze
...
//            Wypelnienie pozostalej czesci ekranu kolorem czarnym
            ...
            //Linia oddzielająca mapę od reszty ekranu
